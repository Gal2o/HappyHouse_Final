...
public class BusinessInfo {
	...
	public BusinessInfo(int no, String shopname, String dong) {
		this.no = no;
		this.shopname = shopname;
		this.dong = dong;
	}
	
	public BusinessInfo(int no, String shopname, String localname, String code1, String codename1, String code2,
	...
	public String toString() {
		return "BusinessAreaInfo [no=" + no + ", shopname=" + shopname + ", localname=" + localname + ", code1=" + code1
